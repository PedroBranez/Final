...
public class OficinasIO {
	...
	public void add() {
		...
		String sql = "Insert into Oficina (nroTitular, nombre, dimensión, nroPlanta, estado) " + "values(?,?,?,?,?)";
		try {
	...
	public void list() throws SQLException {
		...
		while (resultSet.next()) {
			oficina = new Oficina(resultSet.getInt("nroOficina"), resultSet.getInt("nroTitular"),
					resultSet.getString("nombre"), resultSet.getInt("dimensión"), resultSet.getInt("nroPlanta"),
