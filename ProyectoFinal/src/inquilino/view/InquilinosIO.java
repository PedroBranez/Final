...
public class InquilinosIO {
	...
	public void list() throws SQLException {
		...
		while (resultSet.next()) {
			inquilino = new Inquilino(resultSet.getInt("nroInquilino"), resultSet.getInt("CI"),
					resultSet.getString("nombre"), resultSet.getInt("teléfono"), resultSet.getString("dirección"),
	...
	/****************************
	 * Listar Alquileres Inquilino
	 * 
	 * @throws NoExisteInquilino *
	 * @throws SQLException *
	 ****************************/

	public void listAlquiler() throws NoExisteInquilino, SQLException {
		ResultSet resultSet;
		Inquilino inquilino;
		int CI;
		String nombre;
